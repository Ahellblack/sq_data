...
@Component
public class HourTideValve implements Valve<DayVo, Real,TideLevelEntity>, ApplicationContextAware {
    ...
    @Override
    public void doProcess(List<DayVo> realData, List<Real> previousData, Map<Integer, TideLevelEntity> configMap) {
        try {
            //------------------查询出得数据-----------------
