...
//    Real selectEle(@Param("sensorcode") int sensorcode, @Param("time") String time);
    ...
    @Select("select * from abnormal_water_level where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<WaterLevelEntity> fetchAllW();

    @Select("select * from abnormal_flow_velocity where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<FVEntity> fetchAllFV();

    @Select("select * from abnormal_tide_level where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<TideLevelEntity> fetchAllT();

    @Select("select * from abnormal_air_temperature where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<ATEntity> fetchAllAT();

    @Select("select * from abnormal_air_pressure where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<APEntity> fetchAllAP();

    @Select("select * from abnormal_wind_speed where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<WSEntity> fetchWS();

    @Select("select * from abnormal_wind_direction where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<WDEntity> fetchWD();

    @Select("select * from abnormal_rainfall where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
    List<RainfallEntity> fetchAllR();

    @Select("select * from abnormal_electric where sensor_code in (select section_code from config_sensor_section_module where section_status='1')")
