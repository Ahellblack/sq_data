 ...
 */
@Component
public  class RealWDValve implements Valve<RealVo,WDEntity,Real>,ApplicationContextAware {
            ...
            if(vo!=null) {
                ...
                if (realvalue < min) {
                    exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                            ...
                            .dataError(DataError.LESS_SMALL_WD.getErrorCode())
                    ...
                    exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                            ...
                            .sensorCode(vo.getSenId())
                            .errorValue(realvalue)
                            .dataError(DataError.MORE_BIG_WD.getErrorCode())
                            .build());
                }
