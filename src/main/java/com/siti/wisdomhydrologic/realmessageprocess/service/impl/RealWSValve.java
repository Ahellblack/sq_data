 ...
 */
@Component
public  class RealWSValve implements Valve<RealVo,WSEntity,Real>,ApplicationContextAware {
                ...
                if(vo!=null) {
                    ...
                    if (realvalue < min) {
                        exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                                ...
                                .dataError(DataError.LESS_SMALL.getErrorCode())
                                .build());
                        ...
                        exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                                ...
                                .sensorCode(vo.getSenId())
                                .errorValue(realvalue)
                                .dataError(DataError.MORE_BIG.getErrorCode())
                                .build());
                    }
