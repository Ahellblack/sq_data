 ...
 */
@Component
public  class RealATValve implements Valve<RealVo,ATEntity,Real>,ApplicationContextAware {
    ...
    @Override
    public void doProcess(Map<Integer, RealVo> mapval, Map<Integer, ATEntity> configMap, LocalDateTime time, Map<Integer, Real> compare) {
            ...
            if(vo!=null) {
                ...
                if (realvalue < min) {
                    exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                            ...
                            .dataError(DataError.LESS_SMALL_AT.getErrorCode())
                            .build());
                    ...
                    exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                            ...
                            .sensorCode(vo.getSenId())
                            .errorValue(realvalue)
                            .dataError(DataError.MORE_BIG_AT.getErrorCode())
                            .build());
                }
            }else{
